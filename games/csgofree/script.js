...
var items = [
	...
	{name:'CS:GO Weapon Case 2', price:0.00, class:'standard', case:'csgo_weapon2', type:'case', needkey:true, rankNeeded:2},
	{name:'Stattrak Case', price:0.00, class:'standard', case:'stattrak', type:'case', needkey:false, rankNeeded:2},
	{name:'Shadow Case', price:0.00, class:'standard', case:'shadow', type:'case', needkey:true, rankNeeded:2},
	{name:'Falchion Case', price:0.00, class:'standard', case:'falchion', type:'case', needkey:true, rankNeeded:2},
	{name:'The Gods and Monsters Collection', price:0.00, class:'standard', case:'gods_and_monsters', type:'case', needkey:false, rankNeeded:2},
	{name:'CS:GO Weapon Case 3', price:0.00, class:'standard', case:'csgo_weapon3', type:'case', needkey:true, rankNeeded:3},
	{name:'Operation Vanguard Weapon Case', price:0.00, class:'standard', case:'vanguard', type:'case', needkey:true, rankNeeded:3},
	{name:'The Cobblestone Collection', price:0.00, class:'standard', case:'cobblestone', type:'case', needkey:false, rankNeeded:3},
	{name:'Stattrak Case 2', price:0.00, class:'standard', case:'stattrak2', type:'case', needkey:false, rankNeeded:4},
	{name:'Chroma Case 2', price:0.00, class:'standard', case:'chroma2', type:'case', needkey:true, rankNeeded:4},
	{name:'Operation Hydra Case', price:0.00, class:'standard', case:'hydra', type:'case', needkey:true, rankNeeded:4},
	{name:'Revolver Case', price:0.00, class:'standard', case:'revolver', type:'case', needkey:true, rankNeeded:4},
	{name:'Gamma Case 2', price:0.00, class:'standard', case:'gamma2', type:'case', needkey:true, rankNeeded:5},
	{name:'Stattrak Case 3', price:00.00, class:'standard', case:'stattrak3', type:'case', needkey:false, rankNeeded:5},
	{name:'Knife Case', price:0.00, class:'standard', case:'knife', type:'case', needkey:false, rankNeeded:5},
	{name:'Chroma Case 3', price:0.00, class:'standard', case:'chroma3', type:'case', needkey:true, rankNeeded:5},
	{name:'The Chop Shop Collection', price:0.00, class:'standard', case:'chopshop', type:'case', needkey:false, rankNeeded:4},
	{name:'Stattrak Case 4', price:0.00, class:'standard', case:'stattrak4', type:'case', needkey:false, rankNeeded:6},
	{name:'The Rising Sun Collection', price:0.00, class:'standard', case:'risingsun', type:'case', needkey:true, rankNeeded:4},
